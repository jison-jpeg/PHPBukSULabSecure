...
Route::group(['middleware' => ['auth']], function () {
    // Dashboard Routes
    Route::get('/dashboard', [Dashboard::class, 'viewDashboard'])->middleware('auth', 'role:admin,chairperson,college-dean');

    // Attendance Routes
    Route::group(['prefix' => 'attendance'], function () {
        Route::get('/', [AttendanceController::class, 'viewAttendance'])->middleware('auth', 'role:admin,chairperson,college-dean,instructor,student')->name('attendance');
        Route::get('/{sectionId?}/{subjectId?}', [AttendanceController::class, 'viewStudentAttendance'])->name('attendance.student');
    });

    // Subjects Route
    Route::group(['prefix' => 'subjects'], function () {
        Route::get('/', [SubjectController::class, 'viewSubjects'])->middleware('auth', 'role:admin,chairperson,college-dean')->name('subjects');
    ...
    Route::group(['prefix' => 'schedules'], function () {
        Route::get('/', [ScheduleController::class, 'viewSchedules'])->middleware('auth', 'role:admin,chairperson,college-dean,instructor,student')->name('schedules');
    ...
    Route::group(['prefix' => 'laboratories'], function () {
        Route::get('/', [LaboratoriesController::class, 'viewLaboratories'])->name('laboratories')->middleware('auth', 'role:admin,chairperson,college-dean');
    ...
    Route::group(['prefix' => 'users'], function () {
        Route::get('/', [UsersController::class, 'viewUsers'])->middleware('auth', 'role:admin,chairperson,college-dean')->name('users');
    ...
    Route::group(['prefix' => 'students'], function () {
        Route::get('/', [StudentController::class, 'viewStudents'])->middleware('auth', 'role:admin,chairperson,college-dean')->name('students');
    ...
    Route::group(['prefix' => 'colleges'], function () {
        Route::get('/', [CollegeManagementController::class, 'viewColleges'])->middleware('auth', 'role:admin,chairperson,college-dean')->name('colleges');
    ...
    Route::group(['prefix' => 'faculties'], function () {
        Route::get('/', [FacultyController::class, 'viewFaculties'])->middleware('auth', 'role:admin,chairperson,college-dean')->name('faculties');
    ...
    Route::group(['prefix' => 'logs'], function () {
        Route::get('/', [LogsController::class, 'viewLogs'])->middleware('auth', 'role:admin,chairperson,college-dean')->name('logs');
    ...
    Route::group(['prefix' => 'reports'], function () {
        ...
        Route::get('/logs', [LogsReportController::class, 'index'])->name('logs.tableReport');
        // Route::get('/schedule', [ScheduleReportController::class, 'index'])->name('schedule.tableReport');
        // Route::get('/attendance', [AttendanceReportController::class, 'index'])->name('attendance.tableReport');
        // Route::get('/attendance/{sectionId}/{subjectId}', [AttendanceReportController::class, 'viewStudentAttendance'])->name('attendanceStudent.tableReport');
    });
